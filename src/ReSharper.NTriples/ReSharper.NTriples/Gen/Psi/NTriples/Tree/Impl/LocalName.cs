...
namespace ReSharper.NTriples.Impl.Tree {
  internal partial class LocalName : NTriplesCompositeElement, ReSharper.NTriples.Tree.ILocalName {
    internal LocalName() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return ReSharper.NTriples.Impl.Tree.ElementType.LOCAL_NAME; }
    }
