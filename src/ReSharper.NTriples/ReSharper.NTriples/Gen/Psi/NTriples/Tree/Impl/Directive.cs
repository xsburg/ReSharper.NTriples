...
namespace ReSharper.NTriples.Impl.Tree {
  internal partial class Directive : NTriplesCompositeElement, ReSharper.NTriples.Tree.IDirective {
    internal Directive() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return ReSharper.NTriples.Impl.Tree.ElementType.DIRECTIVE; }
    }
