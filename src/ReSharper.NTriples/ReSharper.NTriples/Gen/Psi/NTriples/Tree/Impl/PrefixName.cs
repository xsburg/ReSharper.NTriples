...
namespace ReSharper.NTriples.Impl.Tree {
  internal partial class PrefixName : NTriplesCompositeElement, ReSharper.NTriples.Tree.IPrefixName {
    internal PrefixName() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return ReSharper.NTriples.Impl.Tree.ElementType.PREFIX_NAME; }
    }
    ...
    public override void Accept<TContext>(ReSharper.NTriples.Tree.TreeNodeVisitor<TContext> visitor, TContext context) {
      visitor.VisitPrefixName(this, context);
    }
