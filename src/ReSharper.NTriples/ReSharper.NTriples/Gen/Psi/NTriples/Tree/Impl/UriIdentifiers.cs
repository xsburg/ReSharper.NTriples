...
namespace ReSharper.NTriples.Impl.Tree {
  internal partial class UriIdentifiers : NTriplesCompositeElement, ReSharper.NTriples.Tree.IUriIdentifiers {
    public const short URI_IDENTIFIERS= ChildRole.LAST + 1;
    internal UriIdentifiers() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return ReSharper.NTriples.Impl.Tree.ElementType.URI_IDENTIFIERS; }
    }
    ...
    private static readonly JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short> CHILD_ROLES = new JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short>(
      ...
      {
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(ReSharper.NTriples.Impl.Tree.ElementType.URI_IDENTIFIER, URI_IDENTIFIERS),
      }
    );
