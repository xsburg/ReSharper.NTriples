...
namespace ReSharper.NTriples.Tree {
  public abstract partial class TreeNodeVisitor<TContext, TReturn> {
    ...
    public virtual TReturn VisitNTriplesFile ([JetBrains.Annotations.NotNull] ReSharper.NTriples.Tree.INTriplesFile NTriplesFileParam, TContext context) {
      return VisitNode (NTriplesFileParam, context);
    }
