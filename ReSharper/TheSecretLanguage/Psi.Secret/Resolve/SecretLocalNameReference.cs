    ...
    public class SecretLocalNameReference : SecretReferenceBase
    {
        ...
        public override IReference BindTo(IDeclaredElement element)
        {
            ...
            if (localName.Parent != null)
            {
                ...
                localName.SetName(element.ShortName);
            }
            return this;
        }
        ...
        public override ISymbolTable GetReferenceSymbolTable(bool useReferenceName)
        {
            ...
            if (prefixDeclarations != null)
            {
                ...
                if (prefixDeclaration != null)
                {
                    ...
                    var elements =
                        cache.GetAllUriIdentifierSymbols()
                             .Where(s => s.Namespace == @namespace)
                             .Distinct(s => s.LocalName)
                             .Select(x => new LocalNameDeclaredElement(file, x.LocalName, psiServices));
