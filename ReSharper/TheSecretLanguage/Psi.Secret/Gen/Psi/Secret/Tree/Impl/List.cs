...
namespace JetBrains.ReSharper.Psi.Secret.Impl.Tree {
  internal partial class List : SecretCompositeElement, JetBrains.ReSharper.Psi.Secret.Tree.IList {
    public const short ITEMS= ChildRole.LAST + 1;
    internal List() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.Secret.Impl.Tree.ElementType.LIST; }
    }
    ...
    private static readonly JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short> CHILD_ROLES = new JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short>(
      ...
      {
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(JetBrains.ReSharper.Psi.Secret.Impl.Tree.ElementType.EXPRESSION, ITEMS),
      }
    );
