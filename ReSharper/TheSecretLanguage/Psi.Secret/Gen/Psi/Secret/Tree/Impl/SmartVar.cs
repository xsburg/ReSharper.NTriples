...
namespace JetBrains.ReSharper.Psi.Secret.Impl.Tree {
  internal partial class SmartVar : SecretCompositeElement, JetBrains.ReSharper.Psi.Secret.Tree.ISmartVar {
    internal SmartVar() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.Secret.Impl.Tree.ElementType.SMART_VAR; }
    }
