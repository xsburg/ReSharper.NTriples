...
namespace JetBrains.ReSharper.Psi.Secret.Tree.Impl {
  internal partial class Literal : SecretCompositeElement, JetBrains.ReSharper.Psi.Secret.Tree.ILiteral {
    internal Literal() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.Secret.Tree.Impl.ElementType.LITERAL; }
    }
