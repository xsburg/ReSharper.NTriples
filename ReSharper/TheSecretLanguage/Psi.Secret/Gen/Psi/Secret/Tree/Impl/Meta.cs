...
namespace JetBrains.ReSharper.Psi.Secret.Tree.Impl {
  internal partial class Meta : SecretCompositeElement, JetBrains.ReSharper.Psi.Secret.Tree.IMeta {
    internal Meta() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.Secret.Tree.Impl.ElementType.META; }
    }
