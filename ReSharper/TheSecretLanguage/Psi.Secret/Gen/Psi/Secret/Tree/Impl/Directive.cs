...
namespace JetBrains.ReSharper.Psi.Secret.Tree.Impl {
  internal partial class Directive : SecretCompositeElement, JetBrains.ReSharper.Psi.Secret.Tree.IDirective {
    internal Directive() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.Secret.Tree.Impl.ElementType.DIRECTIVE; }
    }
