...
namespace JetBrains.ReSharper.Psi.Secret.Impl.Tree {
  internal partial class KeywordStatement : SecretCompositeElement, JetBrains.ReSharper.Psi.Secret.Tree.IKeywordStatement {
    internal KeywordStatement() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.Secret.Impl.Tree.ElementType.KEYWORD_STATEMENT; }
    }
    ...
    public override void Accept<TContext>(JetBrains.ReSharper.Psi.Secret.Tree.TreeNodeVisitor<TContext> visitor, TContext context) {
      visitor.VisitKeywordStatement(this, context);
    }
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.Secret.Tree.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitKeywordStatement(this, context);
    }
    public override string ToString() {
      return "IKeywordStatement";
    }
  }
}
