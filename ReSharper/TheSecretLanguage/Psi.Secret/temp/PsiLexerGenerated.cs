...
namespace JetBrains.ReSharper.PsiPlugin.Psi.Psi.Parsing
{
    public partial class PsiLexerGenerated
    {
        ...
        public void Start()
        {
            this.Start(0, yy_buffer.Length, YYINITIAL);
        }
        ...
        public object CurrentPosition
        {
            get
            {
                ...
                tokenPosition.MakeDivide = this.myMakeDivide;
                return tokenPosition;
            }
            set
            {
                var tokenPosition = (TokenPosition)value;
                this.currTokenType = tokenPosition.CurrTokenType;
                ...
                this.myMakeDivide = tokenPosition.MakeDivide;
            }
        }
        ...
        private void locateToken()
        {
            ...
            {
                this.currTokenType = _locateToken();
            }
            if (this.currTokenType != null && !this.currTokenType.IsWhitespace)
            {
                this.myMakeDivide = MAKE_DIVIDE[this.currTokenType];
            }
        }
