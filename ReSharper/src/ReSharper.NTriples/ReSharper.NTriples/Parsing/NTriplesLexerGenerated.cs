...
{
    public partial class NTriplesLexerGenerated : ILexer<NTriplesLexerState>
    {
        ...
        public NTriplesLexerState CurrentPosition
        {
            get
            {
                NTriplesLexerState tokenPosition;
        ...
        object ILexer.CurrentPosition
        {
            ...
            set
            {
                this.CurrentPosition = (NTriplesLexerState)value;
            }
        }
