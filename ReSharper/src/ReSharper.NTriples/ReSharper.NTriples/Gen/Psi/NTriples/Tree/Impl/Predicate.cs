...
namespace ReSharper.NTriples.Impl.Tree {
  internal partial class Predicate : NTriplesCompositeElement, ReSharper.NTriples.Tree.IPredicate {
    public const short EXPRESSION= ChildRole.LAST + 1;
    internal Predicate() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return ReSharper.NTriples.Impl.Tree.ElementType.PREDICATE; }
    }
